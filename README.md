...
| 安卓手机+iOS 双持用户 | 那个顺手就用哪个 |
| 安卓手机+安卓TV<br>iOS+AppleTV<br>多持用户<br>(服务端为amd64) | 随便挑，需要硬件转码就只能官方客户端，不需要就任何一个客户端均可<br>使用JF作为服务端的安卓TV用户目前只有AkfuseKtV可选，要是还需要硬件转码，那只能忍受jellyfin-tv版 |
